...
--
-- Host: localhost
-- Generation Time: Sep 10, 2019 at 05:50 PM
...
CREATE TABLE `perizinan_jenis` (
  `id` int(11) NOT NULL,
  `id_paket_perizinan` tinyint(1) NOT NULL,
...
INSERT INTO `perizinan_jenis` (`id`, `id_paket_perizinan`, `jenis_perizinan`, `nama_lain_perizinan`) VALUES
...
CREATE TABLE `permohonan` (
  ...
  `id_paket_perizinan` tinyint(1) NOT NULL,
  `id_subzona` tinyint(3) NOT NULL,
  `rekomendasi_jenis_perizinan` tinyint(4) NOT NULL COMMENT 'id_jenis_perizinan yang direkomendasikan oleh sistem',
  `create_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
